...
export const Route = createFileRoute("/_authenticated/dashboard/attendance/logs")({
  component: () => (
    <GenericSubModuleView
      ...
      items={[
        { id: "1", title: "Employee #101", subtitle: "Punch In: 08:12 IST · Punch Out: --", status: "On-Site (HQ)", date: "Today", metric: "9h 12m Elapsed" },
        { id: "2", title: "Employee #102", subtitle: "Punch In: 08:45 IST · Punch Out: --", status: "Remote (VPN)", date: "Today", metric: "8h 39m Elapsed" },
      ]}
    />
  ),
});
