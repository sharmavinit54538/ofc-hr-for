...
import { Radio, Send, Plus, Mail, MessageSquare, CheckCircle2 } from "lucide-react";
import { toast } from "sonner";
import { PageHeader } from "@/components/admin/page-header";
import { MOCK_BROADCASTS } from "@/lib/communication/mock-data";
...
function CommunicationBroadcastPage() {
  const [broadcasts] = useState(MOCK_BROADCASTS);
