...
function ScheduledReportsPage() {
  const [jobs, setJobs] = useState<ScheduledJob[]>([
    {
      ...
      frequency: "Weekly",
      recipients: "exec-team@northwind.com, cfo@northwind.com",
      format: "PDF",
    ...
    },
    {
      ...
      frequency: "Daily",
      recipients: "hr-ops@northwind.com",
      format: "Excel",
    ...
    },
    {
      ...
      frequency: "Monthly",
      recipients: "finance-leads@northwind.com",
      format: "Excel",
    ...
    },
    {
      ...
      frequency: "Quarterly",
      recipients: "board@northwind.com",
      format: "PDF",
  ...
  const [formData, setFormData] = useState({
    ...
    recipients: "hr-admin@northwind.com",
