  ...
  head: () => ({
    meta: [
      ...
      { title: "OFC HR · Enterprise AI Workforce Platform" },
      {
        name: "description",
        content:
          "OFC HR (Office Function Consolidator) unifies people operations, workforce planning and AI agents in one enterprise workspace.",
      },
      { name: "author", content: "OFC HR" },
      { property: "og:title", content: "OFC HR · Enterprise AI Workforce Platform" },
      {
        property: "og:description",
        content:
          "One intelligent workspace for consolidated enterprise people operations.",
      },
...
function AuthBootstrap({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    initSession();
  }, [dispatch, triggerRefresh, triggerGetMe]);
